...
Source of authoritative title/agency/date metadata for v1 (per build brief §1.2).
Cache lives at output/nul_cache/{doc_id}.json — keyed on doc_id, not doc_key,
because some accession lookups fall back to the bare barcode.
"""
