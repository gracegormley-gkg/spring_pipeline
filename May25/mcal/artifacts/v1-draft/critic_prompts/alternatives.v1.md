...
# Critic prompt — `alternatives`


- Calibration stage: `v1`
- Conformal bucket: `alternatives+themes`
- Judge model: `sonnet`
...
### Checks specific to `alternatives`
...
Field-specific rules for `alternatives` — apply these first:
...
- `T10_alternatives_chapter_missed` — Structural identification of the Alternatives chapter failed and the field returned empty rather than a not-found status.

## EXAMPLES

Drawn from human grades on this corpus.

### Example 1 — defect (T10_alternatives_chapter_missed)
Document: Buffalo Light Rail
Field: `alternatives`
A human grader recorded: "empty"
Correct handling: this is `T10_alternatives_chapter_missed`. Do not pass it.
