...
Field-specific rules for `eis_type` — apply these first:
...
- `T12_eis_type_confused_with_rod` — Document type misread, typically because 'Record of Decision' appeared in body or citation text rather than as a heading.

## EXAMPLES

Drawn from human grades on this corpus.

### Example 1 — defect (T12_eis_type_confused_with_rod)
Document: Lincoln Hwy Updates
Field: `eis_type`
A human grader recorded: "wrong: "ROD", correct: "Final""
Correct handling: this is `T12_eis_type_confused_with_rod`. Do not pass it.
