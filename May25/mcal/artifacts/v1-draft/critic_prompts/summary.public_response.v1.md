...
# Critic prompt — `summary.public_response`
...
### Checks specific to `summary.public_response`
...
Field-specific rules for `summary.public_response` — apply these first:
...
A human grader recorded: "ok, missing citation - pg 190"
