...
Field-specific rules for `year` — apply these first:
...
- `T11_year_ocr_error` — Publication year is wrong. Observed only on pre-1980 scans, where the real date sits on a signature/approval page or transmittal letter rather than the cover.

## EXAMPLES

Drawn from human grades on this corpus.

### Example 1 — defect (T11_year_ocr_error)
Document: Operation Breakthrough
Field: `year`
A human grader recorded: "wrong: "1972" correct: ... latest date I could find was 1976"
Correct handling: this is `T11_year_ocr_error`. Do not pass it.
