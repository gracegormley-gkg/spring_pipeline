...
# Critic prompt — `summary.environmental_impact`


- Calibration stage: `v1`
- Conformal bucket: `summary_numeric`
- Judge model: `opus`
...
### Checks specific to `summary.environmental_impact`
...
Field-specific rules for `summary.environmental_impact` — apply these first:
...
A human grader recorded: "ok, missing citation - pg 50"
Correct handling: this is `T01_missing_citation`. Do not pass it.

### Example 2 — defect (T02_numeric_hallucination)
Document: Los Angeles Transit
Field: `summary.environmental_impact`
A human grader recorded: "wrong: "Magnitude 7.5" correct: "Magnitude 7.0""
Correct handling: this is `T02_numeric_hallucination`. Do not pass it.

### Example 3 — defect (T03_outside_text_fabrication)
Document: Lincoln Hwy Updates
Field: `summary.environmental_impact`
A human grader recorded: "hallucination: "or important wildlife habitats are affected.""
Correct handling: this is `T03_outside_text_fabrication`. Do not pass it.
