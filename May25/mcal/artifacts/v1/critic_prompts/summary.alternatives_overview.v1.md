...
# Critic prompt — `summary.alternatives_overview`
...
### Checks specific to `summary.alternatives_overview`
...
Field-specific rules for `summary.alternatives_overview` — apply these first:
...
Field: `summary.alternatives_overview`
A human grader recorded: "ok, missing citation - pg 83"
