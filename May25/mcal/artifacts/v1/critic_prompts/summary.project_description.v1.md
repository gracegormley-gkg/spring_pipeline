...
# Critic prompt — `summary.project_description`
...
### Checks specific to `summary.project_description`
...
Field-specific rules for `summary.project_description` — apply these first:
...
Field: `summary.project_description`
A human grader recorded: "ok, missing citation - pg 35"
...
Field: `summary.project_description`
A human grader recorded: "wrong: "from $659 million (Alt. V)" correct: "from $369 million (Alt. XI)""
